...
#define APDS_INITIALIZER {                                           \
	...
	.getLEDDrive				  = getLEDDrive						,\
	.setLEDDrive				  = setLEDDrive						,\
	.getGestureLEDDrive			  = getGestureLEDDrive				,\
	.setGestureLEDDrive			  = setGestureLEDDrive				,\
	.getAmbientLightGain		  = getAmbientLightGain				,\
	.setAmbientLightGain		  = setAmbientLightGain				,\
	.getProximityGain			  = getProximityGain				,\
	.setProximityGain			  = setProximityGain				,\
	.getGestureGain				  = getGestureGain					,\
	.setGestureGain				  = setGestureGain					,\
	.getLightIntLowThreshold	  = getLightIntLowThreshold			,\
	.setLightIntLowThreshold	  = setLightIntLowThreshold			,\
	.getLightIntHighThreshold	  = getLightIntHighThreshold		,\
	.setLightIntHighThreshold	  = setLightIntHighThreshold		,\
	.getProximityIntLowThreshold  = getProximityIntLowThreshold		,\
	.setProximityIntLowThreshold  = setProximityIntLowThreshold		,\
	.getProximityIntHighThreshold = getProximityIntHighThreshold	,\
	.setProximityIntHighThreshold = setProximityIntHighThreshold	,\
	.getAmbientLightIntEnable	  = getAmbientLightIntEnable		,\
	.setAmbientLightIntEnable	  = setAmbientLightIntEnable		,\
	.getProximityIntEnable		  = getProximityIntEnable			,\
	.setProximityIntEnable		  = setProximityIntEnable			,\
	.getGestureIntEnable		  = getGestureIntEnable				,\
	.setGestureIntEnable		  = setGestureIntEnable				,\
	.clearAmbientLightInt		  = clearAmbientLightInt			,\
	.clearProximityInt			  = clearProximityInt				,\
	.readAmbientLight			  = readAmbientLight				,\
	.readRedLight				  = readRedLight					,\
	.readGreenLight				  = readGreenLight					,\
	.readBlueLight				  = readBlueLight					,\
	.readProximity				  = readProximity					,\
	.isGestureAvailable			  = isGestureAvailable				,\
	.readGesture				  = readGesture						,\
	.resetGestureParameters		  = resetGestureParameters			,\
	.processGestureData			  = processGestureData				,\
	.decodeGesture				  = decodeGesture					,\
	.getProxIntLowThresh		  = getProxIntLowThresh				,\
	.setProxIntLowThresh		  = setProxIntLowThresh				,\
	.getProxIntHighThresh		  = getProxIntHighThresh			,\
	.setProxIntHighThresh		  = setProxIntHighThresh			,\
	.getLEDBoost				  = getLEDBoost						,\
	.setLEDBoost				  = setLEDBoost						,\
	.getProxGainCompEnable		  = getProxGainCompEnable			,\
	.setProxGainCompEnable		  = setProxGainCompEnable			,\
	.getProxPhotoMask			  = getProxPhotoMask				,\
	.setProxPhotoMask			  = setProxPhotoMask				,\
	.getGestureEnterThresh		  = getGestureEnterThresh			,\
	.setGestureEnterThresh		  = setGestureEnterThresh			,\
	.getGestureExitThresh		  = getGestureExitThresh			,\
	.setGestureExitThresh		  = setGestureExitThresh			,\
	.getGestureWaitTime			  = getGestureWaitTime				,\
	.setGestureWaitTime			  = setGestureWaitTime				,\
	.getGestureMode				  = getGestureMode					,\
	.setGestureMode				  = setGestureMode					,\
	.wireWriteByte				  = wireWriteByte					,\
	.wireWriteDataByte			  = wireWriteDataByte				,\
	.wireWriteDataBlock			  = wireWriteDataBlock				,\
	.wireReadDataByte			  = wireReadDataByte				,\
	.wireReadDataBlock			  = wireReadDataBlock				 \
}


/* APDS9960 Class */
struct SparkFun_APDS9960T {
	// public:
